MODULE alarrays_dev
    ...
    subroutine allocintgrl_dev(elecs,e1,e2)

        implicit none

        type(elecintrgl_dev), intent(inout),device::elecs
        ...
        call cudaMalloc(elecs,e1*size(real(kind=8)))
    ...
    subroutine deallocintgrl_dev(elecs)
    ...
    subroutine alloczs_dev(zstore,nbf)
        implicit none
    ...
    subroutine alloczf_dev(zs)
        ...
        zs%update_num=0
        return
    end subroutine alloczf_dev

    subroutine dealloczs_dev(zstore)
        implicit none
    ...
    subroutine dealloczf_dev(zs)
        ...
        return
    end subroutine dealloczf_dev

    subroutine allocham_dev(ham,size,diff_size)
    ...
    subroutine allocdv_dev(dvecs,x,length,diff_length)
    ...
    subroutine deallocdv_dev(dvecs)
    ...
    end subroutine deallocerg_dev

    subroutine allocgrad_dev(gradients,num,length)
    ...
    subroutine deallocgrad_dev(gradients)
    ...
    subroutine alloc_oprts_dev(oper,n)
    ...
    end subroutine alloc_oprts_dev

    subroutine alloc_oprts_2_dev(oper,n) 
    ...
    end subroutine alloc_oprts_2_dev

    subroutine dealloc_oprts_2_dev(oper)
    ...
    subroutine dealloc_oprts_dev(oper)
    ...
    end subroutine dealloc_oprts_dev
