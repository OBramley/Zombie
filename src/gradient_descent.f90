        ...
        do while(rjct_cnt.lt.(norb*100))
            ...
            do j=1,ndet-1
                ...
                do n=1,norb
                    ...
                    if((temp%erg .lt. grad_fin%prev_erg).and.abs(temp%zom%num-zstore(j)%num)*0.1.lt.0.25)then
                    ! if((temp%erg .lt. grad_fin%prev_erg).and.abs(temp%zom%num-nel).lt.abs(zstore(j)%num-nel))then
                        acpt_cnt=acpt_cnt+1
